...
class CATSModel(Model):
    ...
    def add_placeholders(self):
        self.input_placeholder = tf.placeholder(dtype=tf.float32, shape=(None, 64, 64, 3), name='X')
    ...
    def add_prediction_op(self):
        ...
        h_flat = tf.reshape(h, shape=(-1, 8 * 8 * 256))
...
def main(debug=True):
    X_tr, Y_tr, X_val, Y_val, X_te = load_data("datasets", resize=(64, 64))
